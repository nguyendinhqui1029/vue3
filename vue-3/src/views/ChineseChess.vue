...
export default {
  ...
  setup() {
    const chessImage = reactive({
      image: {
        'general-black': require('@/assets/images/general-black.svg'),
        'advisor-black': require('@/assets/images/advisor-black.svg'),
        'cannon-black': require('@/assets/images/cannon-black.svg'),
        'chariot-black': require('@/assets/images/chariot-black.svg'),
        'elephant-black': require('@/assets/images/elephant-black.svg'),
        'horse-black': require('@/assets/images/horse-black.svg'),
        'soldier-black': require('@/assets/images/soldier-black.svg'),
        'general-red': require('@/assets/images/general-red.svg'),
        'advisor-red': require('@/assets/images/advisor-red.svg'),
        'cannon-red': require('@/assets/images/cannon-red.svg'),
        'chariot-red': require('@/assets/images/chariot-red.svg'),
        'elephant-red': require('@/assets/images/elephant-red.svg'),
        'horse-red': require('@/assets/images/horse-red.svg'),
        'soldier-red': require('@/assets/images/soldier-red.svg')
      }
    });
