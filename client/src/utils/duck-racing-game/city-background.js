export class CityBackground {
  ...
  drawCity() {
    ...
    this.context.drawImage(this.playerImage, 0, 0,this.widthCity,this.heightCity,this.canvas.width+this.x - 2,0, this.canvas.width ,this.canvas.height);
    if(this.start) {
      this.x-= this.speed;
    }
    this.cancelAnimation= requestAnimationFrame(this.drawCity.bind(this));
  }
}